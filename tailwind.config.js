  ...
  theme: {
    extend: {
      colors: {
        ...
        "primitive-color-neutral-neutral-dark":
          "var(--primitive-color-neutral-neutral-dark)",
        "primitive-color-neutral-neutral-darker":
          "var(--primitive-color-neutral-neutral-darker)",
        "primitive-color-neutral-neutral-light":
          "var(--primitive-color-neutral-neutral-light)",
        ...
        // Custom color palette can be added here if needed
      },
      fontFamily: {
