...
const SignUp = () => {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      toast.success(`Welcome, ${user.displayName || "User"}! Successfully signed in.`, {
        position: "top-right",
        autoClose: 3000,
            ...
            <div className="w-full max-w-md">
              ...
              <div className="flex justify-center mb-8">
                <button
                  ...
                  disabled={isLoading}
                  className={`w-full max-w-[403.5px] h-12 rounded-[10px] px-3 py-1.5 flex items-center justify-center gap-2.5 border-[2px] transition ${
              ...
              <div className="w-full flex justify-center mb-4">
                <button
                  className="w-full max-w-[403.5px] h-12 rounded-[10px] bg-[#EB010C] text-white flex items-center justify-center gap-2.5 px-4 border border-gray-300 hover:bg-red-600 transition"
