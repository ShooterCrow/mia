            ...
            <div className="mb-6">
                {
                    ...
                    <h2 className="text-lg font-medium text-gray-700 dark:text-gray-300 mb-3">
                        Selected Categories ({selectedCategories.length}/{categories.length})
                    </h2>
                }
                    ...
                    return (
                        <label
                            ...
                            className={`flex items-center p-4 border rounded-lg cursor-pointer transition-colors
                                ${isSelected ? 'bg-gray-100 dark:bg-gray-800 border-blue-500' : 'border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800'}
                            `}
                        >
                            <input
                                id={category.id}
