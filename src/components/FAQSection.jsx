      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-4 sm:space-y-6">
          {faqs.map((faq, index) => (
            <div 
              key={faq.id} 
              className="bg-white w-full shadow-sm border border-gray-200 overflow-hidden transition-all duration-200 hover:shadow-md">
              {/* Question Header */}
              <button
                onClick={() => toggleFAQ(index)}
                className="w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-6 text-left flex justify-between items-center hover:bg-gray-50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-inset"
              >
                ...
                <div className="flex-shrink-0">
                  {openIndex === index ? (
                    ...
                    <Plus className="w-5 h-5 sm:w-6 sm:h-6 text-gray-400 transition-transform duration-200" />
                  )}
                </div>
              </button>
        ...
        <div className="text-center mt-12 sm:mt-16">
          <p className="text-sm sm:text-base text-gray-500">
            ...
            <a 
              href="#contact" 
              className="text-red-500 hover:text-red-600 font-medium ml-1 transition-colors duration-200">
