...
const HeroSection = ({text, btnTxt, border, image}) => {
    ...
    return (
        <div className={`my-10 max-w-7xl mx-auto relative gap-4 ${border && "rounded-lg"} flex flex-col h-[50vh] md:h-[80vh] justify-center items-center overflow-hidden bg-gradient-to-br from-red-400 to-red-600 dark:from-red-500 dark:to-red-700`}>
            {/* Background Image */}
            <div
